...
function analytics_portal_preprocess_page(&$vars, $hook) {
    if (drupal_is_front_page() && !(user_is_logged_in())) {
        // If the content type's machine name is "my_machine_name" the file
        // name will be "page--my-machine-name.tpl.php".
        $vars['theme_hook_suggestions'][] = 'page__front__loggedin';
    }
}
...
function analytics_portal_theme() {

$items = array();
 
  $items['user_login'] = array(
      'render element' => 'form',
      'path' => drupal_get_path('theme', 'analytics_portal') . '/templates',
      'template' => 'user-login',
  );
    $items['header'] = array(
...
function analytics_portal_button($variables) {
...
function analytics_portal_menu_tree__main_menu(&$vars) {
    return '<ul class="nav navbar-nav">' . $vars['tree'] . '</ul>';
}
function analytics_portal_css_alter(&$css) {
